		...
		<div class="row d-flex align-items-center">
			...
			<div class="col-6">
				<div class="input-group">
					...
					<input id="shBar" name="shBar" onkeyup="enterkey();" class="form-control" type="text" placeholder="찾고 싶은 상품을 검색해보세요!">
			...
			<div class="col">
				...
				<ul class="nav">
					<li class="nav-item dropdown"><a class="btn borderX dropdown">
					...
					<li class="nav-item"><a id="btnMyCart" class="btn borderX">
				...
				<!-- 
							<button type="button" class="btn borderX dropdown">
								<i class="bi bi-person fs-3"></i>
								<div class="btnText">마이쿠팡</div>
								<ul class="dropdown-menu">
									<li><a class="dropdown-item">주문목록</a></li>
									<li><a class="dropdown-item">취소/반품</a></li>
									<li><a class="dropdown-item">찜 리스트</a></li>
								</ul>
							</button>
							<button id="btnMyCart" type="button" class="btn borderX">
								<i class="bi bi-cart4 fs-3"></i>
