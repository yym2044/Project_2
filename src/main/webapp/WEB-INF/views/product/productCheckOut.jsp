									...
									<c:forEach items="${listAddress}" var="item" varStatus="status">
										<div class="col-12">
											<div class="card" style="width: 100%;">
												<div class="card-body">
													<h5 class="card-title"><c:out value="${rt.ifmmName}"/><c:if test="${item.ifmaDefaultNy eq 1}"><span class="badge rounded-pill bg-primary" style="font-size: small;">기본 배송지</span></c:if></h5>
													<p class="card-text"><c:out value="${item.ifmaAddress1}"/>, <c:out value="${item.ifmaAddress2}"/></p>
